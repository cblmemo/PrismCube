...
public class MxStarParser extends Parser {
    ...
    public static class SingleVariableDefineContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_singleVariableDefine;
        }
    ...
    public static class BlockStatementContext extends StatementContext {
        ...
        public BlockStatementContext(StatementContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class VariableDefineStatementContext extends StatementContext {
        ...
        public VariableDefineStatementContext(StatementContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class AddressingExpressionContext extends ExpressionContext {
        ...
        public AddressingExpressionContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class PostCrementExpressionContext extends ExpressionContext {
        ...
        public PostCrementExpressionContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NewTypeExpressionContext extends ExpressionContext {
        ...
        public NewTypeExpressionContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class ErrorNewArrayContext extends NewTypeContext {
        ...
        public ErrorNewArrayContext(NewTypeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NewObjectConstructContext extends NewTypeContext {
        ...
        public NewObjectConstructContext(NewTypeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NewObjectContext extends NewTypeContext {
        ...
        public NewObjectContext(NewTypeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NewArrayContext extends NewTypeContext {
        ...
        public NewArrayContext(NewTypeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class LiteralContext extends ParserRuleContext {
        public TerminalNode NumericalConstant() {
            return getToken(MxStarParser.NumericalConstant, 0);
        }
        ...
        public TerminalNode NullConstant() {
            return getToken(MxStarParser.NullConstant, 0);
        }
