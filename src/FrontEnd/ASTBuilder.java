...
/**
 * This class accepts parse tree generated by antlr4, and
 * builds a custom abstract syntax tree from parse tree.
 *
 * @author rainy memory
 * @version 1.0.0
 */
...
public class ASTBuilder extends MxStarBaseVisitor<ASTNode> {
    ...
    /**
     * This variable's top represents whether identifier is
     * a variable or a function.
     */
    private final Stack<identifierType> stack = new Stack<>();

    /**
     * This method builds abstract syntax tree and store
     * it to memory.
     *
     * @see Memory
     */
    ...
    public ASTNode visitNonArrayType(MxStarParser.NonArrayTypeContext ctx) {
        ...
        // type name identifier is neither variable nor function
    ...
    public ASTNode visitMemberAccessExpression(MxStarParser.MemberAccessExpressionContext ctx) {
        // make sure instance will be marked as variable
        ...
        // step in from function call expression
    ...
    public ASTNode visitFunctionCallExpression(MxStarParser.FunctionCallExpressionContext ctx) {
        // when function is a method, visit(ctx.expression()) will step into member access expression.
        // push identifierType.function into stack make sure it will be marked as a function.
        ...
        } else if (function instanceof IdentifierPrimaryNode) ret.setFunctionName(((IdentifierPrimaryNode) function).getIdentifier());
    ...
    public ASTNode visitPrimary(MxStarParser.PrimaryContext ctx) {
        ...
        // figure out whether primary is a variable or a function
    ...
    public ASTNode visitErrorNewArray(MxStarParser.ErrorNewArrayContext ctx) {
        // this node represents an error new array define
