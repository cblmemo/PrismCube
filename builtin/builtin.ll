...
define i8* @toString(i32) #0 {
  ...
  %3 = alloca i8*, align 8
  store i32 %0, i32* %2, align 4
  %4 = call noalias i8* @malloc(i64 20) #4
...
define i8* @__mx_concatenateString(i8*, i8*) #0 {
  ...
  %24 = call i8* @strcat(i8* %22, i8* %23) #4
...
; Function Attrs: noinline nounwind optnone uwtable
define i32 @__mx_stringLength(i8*) #0 {
  %2 = alloca i8*, align 8
  store i8* %0, i8** %2, align 8
  %3 = load i8*, i8** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define i8* @__mx_stringSubstring(i8*, i32, i32) #0 {
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
  ...
  %23 = call i8* @strncat(i8* %16, i8* %20, i64 %22) #4
...
; Function Attrs: noinline nounwind optnone uwtable
define i32 @__mx_stringParseInt(i8*) #0 {
  %2 = alloca i8*, align 8
  store i8* %0, i8** %2, align 8
  %3 = load i8*, i8** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define i32 @__mx_stringOrd(i8*, i32) #0 {
  %3 = alloca i8*, align 8
